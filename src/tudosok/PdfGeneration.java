...
//            document.add(new Paragraph("\n\n\n" + text, FontFactory.getFont("betutipus", BaseFont.IDENTITY_H, BaseFont.EMBEDDED)));
            ...
            table.addCell("Életkor");
//            table.addCell("Fokozat");
            ...
            for (int i = 1; i <= data.size(); i++) {
                ...
                table.addCell(actualPerson.getAge());
//                table.addCell(actualPerson.getTypeDegree());
            }
            ...
            //Aláírás
            Chunk signature = new Chunk("\n\n Generálva a Tudosok alkalmazás segítségével.");
